...
export default function AgenciesLanding() {
  ...
  const getRandomRestaurants = (arr: Restaurant[], count: number) => {
    const shuffled = [...arr].sort(() => Math.random() - 0.5) // Mezcla la lista
    return shuffled.slice(0, count) // Devuelve los primeros 'count' restaurantes
  }
    ...
    <div className='container mx-auto px-4 py-4 h-auto flex flex-col '>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-4 pb-4'>
        ...
        <a href='#bares'>
          <Button
            type='button'
            className='w-full bg-pink-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-pink-600 transition-all'
          >
            Bares
          </Button>
        </a>
      ...
      <div id='loMasNuevo' className=' p-6'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
          {/* Mostrar 4 restaurantes aleatorios */}
